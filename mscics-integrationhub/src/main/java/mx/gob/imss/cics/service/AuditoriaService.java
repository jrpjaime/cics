...
public class AuditoriaService {
    ...
    public void registrarBitacora(String apiUser, String programa, String trans, String entrada, int rc, long ms, String estado, String error, String uuidTransaccion) {
        /*
        String sql = "INSERT INTO MSCT_AUDITORIA_CICS (" +
                     ...
                     "DES_ESTADO_TRANS, REF_ERROR_LOG, COD_TRANSACCION_UNICA, STP_CREACION) " +
        ...
        try {
            jdbcTemplate.update(sql, apiUser, programa, trans, entrada, rc, ms, estado, error, uuidTransaccion);
        } catch (Exception e) {
