...
public class Test18 implements Serializable {
	...
	public static void main(String[] args) {
		...
		test.servicioCICS.enviaReciveCadena("**********GC1115937811147", "PEMI091", "MEX2511","EGHLA001", "GC11");
		/*do
		{
			System.out.println("en el do enviaReciveCadena "  );
			respuesta = test.servicioCICS.enviaReciveCadena("QUEUE", "PEMI091", "MEX2511","EGHLA002", "GC12").replaceAll(" ", "");
