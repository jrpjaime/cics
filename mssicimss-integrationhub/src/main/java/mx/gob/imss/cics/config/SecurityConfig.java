    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/mssicimss-integrationhub/v1/auth/**").permitAll() // Login abierto
                .requestMatchers("/mssicimss-integrationhub/v1/info").permitAll()   // Info abierta
                .requestMatchers("/mssicimss-integrationhub/v1/actuator/**").permitAll()  // PERMITIR EL ENDPOINT DE MONITOREO
    ...
    public WebMvcConfigurer corsConfigurer() {
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                registry.addMapping("/**")
                        .allowedOrigins("http://localhost:4200") // Origen explícito  
